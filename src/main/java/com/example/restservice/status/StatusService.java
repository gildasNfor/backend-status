...
import com.example.restservice.statusPreview.StatusPreview;
...
//        }
        ...
        if(!(statusImage == null)){
            ...
            System.out.println(imageFileExtension);
            if(!(imageFileExtension.equalsIgnoreCase("png") || imageFileExtension.equalsIgnoreCase("jpg") || imageFileExtension.equalsIgnoreCase("jpeg"))) throw new BadRequestException("You need to provide an image here");
        ...
        if(!(statusVideo == null)){
            ...
            if(!(videoFileExtension.equalsIgnoreCase("mp4") || videoFileExtension.equalsIgnoreCase("MOV")) ) throw new BadRequestException("You need to provide a video here");
        ...
        Status status = new Status(userNumber, thePostTime, theStatusCaption, theStatusText, theStatusImage, theStatusVideo, isPublicStatus, disappearTime, duration );
